...
public class Rain_Manager : MonoBehaviour
{
    ...
    [Range(0, 100)]
    [SerializeField] private float _RainIntensity = 0;
    [Space]
    ...
    [SerializeField] private Material Material; // Skybox Material
    [Space]
    ...
    private void Update()
    {
        AkSoundEngine.SetRTPCValue(_RainIntensityRTPC.Name, _RainIntensity);
        ...
        {
            _RainIntensity %= 100;
            UpdateLighting(_RainIntensity / 100f); // Rotation de la Directional Light en fonction du slider RTPC 
    ...
    private void UpdateLighting(float timePercent)
    {
        ...
        RenderSettings.skybox.SetFloat("_Rotation", _RainIntensity); // Rotation de la Skybox en fonction du slider RTPC 
